...
export const messages = {
  en: {
    ...
    "ai.err.aborted": "Request cancelled.",
    "ai.err.timeout":
      "The request timed out. The model may be slow or unreachable — try again or switch provider.",
    "ai.err.auth":
      "Authentication failed. Check the API Key for this provider.",
    "ai.err.rateLimit": "Rate limited. Wait a moment and try again.",
    "ai.err.network":
      "Network error. Check your connection and the Base URL.",
    "ai.err.provider": "Provider error: {msg}",
    "redactMode.hidden": "Hidden (********)",
    "redactMode.delivery": "Delivery (<REDACTED>)",
    "settings.redactDomain": "Redact domains",
    "settings.fontSizeHint": "{n}px",
    "aiMenu.showKey": "Show",
    "aiMenu.hideKey": "Hide",
    "aiMenu.badUrl": "URL should start with http:// or https://",
    "history.saveFailed": "History save failed (formatting still succeeded).",
    "history.filterLang": "All languages",
    "history.filterRisk": "All risk levels",
    "history.noMatch": "No snippets match your search/filters.",
    "history.count": "{n} item(s)",
    "tab.hint.security": "Ctrl/⌘+1",
    "tab.hint.warnings": "Ctrl/⌘+2",
    "tab.hint.ai": "Ctrl/⌘+3",
  ...
  zh: {
    ...
    "ai.err.aborted": "请求已取消。",
    "ai.err.timeout": "请求超时。模型可能较慢或无法连接 —— 请重试或更换 Provider。",
    "ai.err.auth": "鉴权失败。请检查该 Provider 的 API Key。",
    "ai.err.rateLimit": "触发限流。请稍候再试。",
    "ai.err.network": "网络错误。请检查网络连接和 Base URL。",
    "ai.err.provider": "Provider 错误:{msg}",
    "redactMode.hidden": "隐藏 (********)",
    "redactMode.delivery": "交付占位 (<REDACTED>)",
    "settings.redactDomain": "脱敏域名",
    "settings.fontSizeHint": "{n}px",
    "aiMenu.showKey": "显示",
    "aiMenu.hideKey": "隐藏",
    "aiMenu.badUrl": "URL 应以 http:// 或 https:// 开头",
    "history.saveFailed": "历史保存失败(格式化本身已成功)。",
    "history.filterLang": "全部语言",
    "history.filterRisk": "全部风险等级",
    "history.noMatch": "没有匹配搜索/筛选条件的记录。",
    "history.count": "{n} 条",
    "tab.hint.security": "Ctrl/⌘+1",
    "tab.hint.warnings": "Ctrl/⌘+2",
    "tab.hint.ai": "Ctrl/⌘+3",
